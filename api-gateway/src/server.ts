...
import { getLeaderboardScript, getLeaderboardScriptArgs, CadenceJSONValue, ScoreRecordJSON } from "flow-sdk";
import { env } from "shared-utils";
import { Base64 } from "js-base64";

async function callCadenceScript(script: string, args: CadenceJSONValue[]): Promise<any> {
  const endpoint = () => env("FLOW_REST", "https://rest-testnet.onflow.org");
